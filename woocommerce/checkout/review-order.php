...
<div class="shop_table woocommerce-checkout-review-order-table">
	...
	<div
		class="item-review-order <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
		<div class="wrap-img">
			<div class="img">
