...
<div class="woocommerce-order">
	...
	<section class="section-checkout-success section-py">
		<div class="container">
			<div class="wrap-progress-steps" style="display: none;">
			...
			<div class="section-wrap-box-white p-10 ">
				<div class="row gap-y-5">
					<div class="col md:w-6/12" style="display: none;">
					...
					<div class="col md:w-6/12 flex flex-col justify-center items-start">
						...
						<p class="mb-5"><?= _e('Mã Đơn hàng của bạn là:', 'canhcamtheme') ?>
		...
		<div class="container">
			...
			<div class="section-wrap-box-white p-10 ">
				<div class="row gap-y-5">
					...
					<div class="col  flex flex-col justify-center items-start">
						<h1 class="title-48px text-primary-green mb-6">
							<?= _e('Thank you!', 'canhcamtheme') ?>
						</h1>
						<div class="format-content mb-5">
							<p class="">
								<?= _e('Cảm ơn quý khách đã tin tưởng và mua sắm tại website của chúng tôi.', 'canhcamtheme') ?>
							</p>
							<p class=""><?= _e('Mã đơn hàng của quý khách là:', 'canhcamtheme') ?><strong>
									#<?php echo $order->get_order_number(); ?></strong>
								<?= _e('Hiện tại đơn hàng của bạn đang được xử lý.', 'canhcamtheme') ?></p>
						</div>
						<div class="mb-5">
							<?php do_action('woocommerce_thankyou_' . $order->get_payment_method(), $order->get_id()); ?>
						</div>
						<div class="format-content">
							<p class="mb-5">
								<?= _e('Hiện tại đơn hàng của bạn đang được xử lý. Thông tin chi tiết đơn hàng sẽ được gửi đến hộp thư của bạn:', 'canhcamtheme') ?>
								<?php echo $order->get_billing_email(); ?></p>
						</div>
